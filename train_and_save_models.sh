...
python train_m3ddpg.py log_files/m3ddpg/moving_avg.txt > log_files/m3ddpg/training_log.txt &
python train_maddpg_deterministic.py log_files/maddpg_d/moving_avg.txt > log_files/maddpg_d/training_log.txt &
python train_m3ddpg_deterministic.py log_files/m3ddpg_d/moving_avg.txt > log_files/m3ddpg_d/training_log.txt &
