...
class MemoryBuffer(object):
    ...
    def memorize(self, state, action, op_action, reward, done, new_state, error=None):
        """ Save an experience to memory, optionally with its TD-Error
        """

        experience = (state, action, op_action, reward, done, new_state)
        if(self.with_per):
